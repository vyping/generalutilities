...
import static com.vyping.business.utilities.definitions.Modules.MODULE_ICON_LOGUP;
import static com.vyping.business.utilities.definitions.Modules.MODULE_NAME_LOGUP;
...
import com.vyping.business.databinding.LogupActivityBinding;
...
public class LogupActivity extends MyLoginActivity {
    ...
    protected void CreateActivity() {
        ...
        this.binding = (LogupActivityBinding) activity(LogupActivity.this, R.layout.logup_activity).actionBar(MODULE_ICON_LOGUP, MODULE_NAME_LOGUP).onBack(LogActivity.class).binding();
    }

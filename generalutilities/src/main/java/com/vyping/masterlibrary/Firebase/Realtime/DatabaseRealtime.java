...
public abstract class DatabaseRealtime extends Readers {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot childSnapshot : dataSnapshot.getChildren()) {
                        ...
                        DatabaseRealtime.this.dataSnapshot = childSnapshot;
                        String key = getKeyString(DatabaseRealtime.this.dataSnapshot);

...
public class RecyclerHandler2<T> extends BaseObservable {
    ...
    public RecyclerHandler2(RecyclerHandlerInterfase<T> modelBinder, boolean searched) {
    ...
    public void loadMethodHandler(@NonNull RecyclerHandler2<T> recyclerHandler) {
    ...
    public void addMethodHandler(@NonNull RecyclerHandler2<T> recyclerHandler) {

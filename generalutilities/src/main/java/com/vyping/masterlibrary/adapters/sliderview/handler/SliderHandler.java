...
public class SliderHandler<T> extends BaseObservable {

    private final SliderHandlerInterfase<T> methodInterfase;
    ...
    public SliderHandler(SliderHandlerInterfase<T> modelBinder, boolean searched) {

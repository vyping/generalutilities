...
public class SpinnerHandler<T> extends BaseObservable {

    private final SpinnerHandlerInterfase<T> methodInterfase;
    ...
    public SpinnerHandler(SpinnerHandlerInterfase<T> modelBinder, boolean searched) {

...
public class RecyclerItems<T> extends BaseObservable {
    ...
    public RecyclerItems(RecyclerHandlerInterfase<T> modelBinder, boolean searched) {
    ...
    public void loadMethodHandler(@NonNull RecyclerItems<T> recyclerHandler) {
    ...
    public void addMethodHandler(@NonNull RecyclerItems<T> recyclerHandler) {

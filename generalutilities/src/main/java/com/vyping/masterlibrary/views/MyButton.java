...
public class MyButton {
    ...
    @NonNull
    public Button createByAttributes(@NonNull Context context, int attr, int style, View.OnClickListener listener) {
    ...
    @NonNull
    public Button createByAttributes(@NonNull Context context, int attr, int style, String text, View.OnClickListener listener) {
    ...
    @NonNull
    public Button createByAttributes(@NonNull Context context, @NonNull LinearLayout layout, int attr, int style, int icon, @Definitions.IconPosition int iconPos, String text, View.OnClickListener listener) {
